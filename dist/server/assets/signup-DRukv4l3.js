...
import { k as createLucideIcon, V as useNavigate, B as Button, L as Link, P as toast } from "./router-50lD0_tQ.js";
  ...
  if (sent) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex max-w-md flex-col px-4 py-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-sm text-muted-foreground", children: [
        ...
        ". Click the link to activate your account and you'll land on My Account."
      ] }),
