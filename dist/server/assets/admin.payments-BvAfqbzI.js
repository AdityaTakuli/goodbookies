...
import { j as adminListPayments, p as adminPaymentsSummary } from "./admin.functions-DfS6ZKoB.js";
...
function AdminPayments() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-3", children: [{
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `mt-2 font-display text-2xl font-bold ${c.accent ? "text-primary" : ""}`, children: c.value != null ? `₹${c.value.toLocaleString()}` : "—" })
    ] }, c.label)) }),
