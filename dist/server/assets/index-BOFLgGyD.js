import { Q as jsxRuntimeExports } from "./server-sEOaxYT2.js";
import { m as createLucideIcon, c as Route, E as organizationJsonLd, a6 as websiteJsonLd, H as HERO_SRCSET, u as heroMobileWebp, L as Link, B as Button } from "./router-ByvzUWBt.js";
import { J as JsonLd } from "./JsonLd-CTTPBxJn.js";
import { M as MapPin } from "./map-pin-DWns1jdc.js";
import { C as Calendar } from "./calendar-CkCy3alc.js";
...
function Index() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container mx-auto px-4 py-16 md:py-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid min-h-[280px] grid-cols-2 gap-4 sm:grid-cols-3 md:min-h-0 md:grid-cols-5", children: sports.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/sports", search: {
        sport: s.slug
      }, className: "group flex aspect-square flex-col items-center justify-center rounded-2xl border border-border/60 bg-card transition-colors hover:border-primary", children: [
