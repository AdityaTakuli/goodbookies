import { Q as jsxRuntimeExports, _ as reactExports } from "./server-Dz5ce8OK.js";
import { s as createLucideIcon, p as cn, aa as useComposedRefs, y as getMyPlayerDashboard, a8 as updatePlayerProfileSettings, G as listInventoryClubs, I as listInventoryFlags, F as listAvatarInventory, ac as useQueryClient, c as Link, B as Button, a7 as toast } from "./router-BDNr6ult.js";
...
import { F as FutPlayerCard, S as ShareCardButton, M as MatchHistoryList } from "./ShareCardButton-BgQjXwKz.js";
import { I as Input } from "./input-l8do17Kt.js";
import { L as Label } from "./label-Co9BpwK1.js";
import { u as useControllableState, P as Primitive, c as composeEventHandlers, b as createContextScope } from "./index-C_ZfFWml.js";
import { u as usePrevious, a as useSize, E as ExternalLink } from "./index-7np5M3eG.js";
import { p as parseSkillLevel, P as PLAYER_SKILL_LEVELS, a as PLAYER_SKILL_LEVEL_LABELS } from "./player-card.utils-BnNWF6RS.js";
import { u as uploadMediaFile, a as uploadMediaFileToHostinger } from "./upload-client-DCIzG63F.js";
import { r as resolveMediaUrl } from "./urls-DQ8wDDis.js";
...
function CardBuilderStatsPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
      ...
      sport === "football" || sport === "cricket" ? "Includes turf-verified games and your self-scored matches (this sport only)" : "Turf-verified only, updated when venue owners confirm matches"
    ] }),
...
function MyBookiesDashboard() {
    ...
    try {
      ...
      await saveFn({
        data: {
          ...
          avatar_url: avatarPreviewUrl && !avatarPreviewUrl.startsWith("data:") ? avatarPreviewUrl : void 0,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 sm:space-y-6 md:space-y-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "-mx-1 flex gap-2 overflow-x-auto overscroll-x-contain px-1 pb-2 pr-4 [scrollbar-width:none] md:mx-0 md:flex-wrap md:overflow-visible md:px-0 md:pb-0 md:pr-0 [&::-webkit-scrollbar]:hidden", children: PLAYER_SPORT_SLUGS.map((slug) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setSport(slug), className: cn("shrink-0 rounded-full px-4 py-2.5 text-sm font-semibold transition-colors sm:py-2", sport === slug ? "bg-primary text-primary-foreground" : "bg-[#142219] text-muted-foreground hover:text-foreground"), children: [
      SPORT_CONFIGS[slug].icon,
      " ",
      SPORT_CONFIGS[slug].name
    ] }, slug)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 grid gap-5 md:mt-0 md:grid-cols-[minmax(0,18.75rem)_1fr] md:gap-6 lg:grid-cols-[minmax(0,20rem)_1fr] lg:gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-1 md:sticky md:top-20 md:self-start lg:top-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 sm:space-y-4", children: [
        ...
        preview && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "player-card-preview-shell flex flex-col items-center gap-3 sm:gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FutPlayerCard, { data: preview, captureId: "dashboard-fut-card" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-2 min-w-0 space-y-4 sm:space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardBuilderSection, { title: "Identity", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => fileRef.current?.click(), className: "relative mx-auto flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-full border-2 border-dashed border-primary/40 bg-[#0B130E] hover:border-primary sm:mx-0 disabled:opacity-60", disabled: avatarUploading, children: [
            avatarPreviewUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: resolveMediaUrl(avatarPreviewUrl), alt: "", className: "h-full w-full object-cover" }) : avatarInventoryId ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: avatars?.avatars?.find((a) => a.id === avatarInventoryId)?.emoji ?? "👤" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Camera, { className: "h-7 w-7 text-primary/70" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-xl border border-[#1E3A27]/80 bg-[#142219] p-4 sm:rounded-2xl sm:p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Turf-verified scorelines and self-scored matches (filtered by sport)" }),
