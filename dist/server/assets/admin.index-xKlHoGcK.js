import { a as React2, A as getDefaultExportFromCjs, _ as reactExports, Q as jsxRuntimeExports } from "./server-DBPAyUSz.js";
import { u as useQuery } from "./useQuery-DqoAjqbY.js";
import { u as useServerFn } from "./useServerFn-DZ1aM4JE.js";
import { t as adminSummary, r as adminRevenueSeries, b as adminBookingsBySport, u as adminTopVenues, i as adminListBookings, c as adminBookingsVolume } from "./admin.functions-BB6g5bG7.js";
import { f as formatBookingPlayerNames } from "./booking-display-BVPu9KGs.js";
import { S as StatusBadge } from "./StatusBadge-D5yXZL7r.js";
import { C as CalendarCheck } from "./calendar-check-TOjSoA61.js";
import { I as IndianRupee } from "./indian-rupee-FibcgFDi.js";
import { j as createLucideIcon, f as clsx } from "./router-BQFvuqhx.js";
import { B as Building2 } from "./building-2-DDCqQV_W.js";
import { C as CircleX } from "./circle-x-DNp5ep1v.js";
import { j as filterProps, J as require_baseExtremum, K as require_baseGt, M as require_baseIteratee, N as require_baseLt, x as isFunction, T as Text, I as polarToCartesian, d as Layer, s as getTickClassName, i as adaptEventsOfChild, L as Label, D as Dot, b as Curve, z as isNil, t as getValueByDataKey, S as Shape, A as Animate, o as get, v as interpolateNumber, w as isEqual, E as isNumber, c as LabelList, O as uniqueId, G as Global, F as mathSign, k as findAllByType, a as Cell, q as getMaxRadius, r as getPercentValue, P as warn, n as generateCategoricalChart, l as formatAxisMap, R as ResponsiveContainer, g as LineChart, C as CartesianGrid, X as XAxis, Y as YAxis, h as Tooltip, f as Line, e as Legend, B as Bar } from "./LineChart-DclHhbNb.js";
...
function AdminOverview() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Platform health at a glance." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Kpi, { icon: TrendingUp, label: "Revenue this month", value: sum ? `₹${sum.revenueMonth.toLocaleString()}` : "—" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Kpi, { icon: Building2, label: "Active venues", value: sum?.activeVenues ?? "—" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Kpi, { icon: UserPlus, label: "New users (7d)", value: sum?.newUsersWeek ?? "—" }),
