...
import { j as createLucideIcon, e as Route, L as Link, B as Button } from "./router-ChFUjCpX.js";
...
function SuccessPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex max-w-lg flex-col items-center px-4 py-20 text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-muted-foreground", children: "Your booking is confirmed. We've saved the slot for you." }),
