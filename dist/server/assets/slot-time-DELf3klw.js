...
function selectionEndFromSlots(slotStarts, stepMinutes) {
  if (slotStarts.length === 0) return null;
  return slotStarts[slotStarts.length - 1] + stepMinutes;
}
function visualHighlightForSlots(slotStarts, stepMinutes) {
...
export {
  ...
  slotPriceTotal as n,
  slotStepMinutes as o,
  venueOpenMinutes as p,
  visualHighlightForSlots as q,
  visualTilesFromAnchors as r,
  selectionEndFromSlots as s,
