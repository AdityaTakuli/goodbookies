import { Q as jsxRuntimeExports } from "./server-JtEQqRvP.js";
import { m as createLucideIcon, c as Route, E as organizationJsonLd, a6 as websiteJsonLd, H as HERO_SRCSET, u as heroMobileWebp, L as Link, B as Button } from "./router-dv40W4LO.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container mx-auto px-4 py-16 md:py-20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid min-h-[280px] grid-cols-2 gap-4 sm:grid-cols-3 md:min-h-0 md:grid-cols-5", children: sports.map((s) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/sports", search: {
          sport: s.slug
        }, className: "group relative flex aspect-square flex-col items-center justify-end overflow-hidden rounded-2xl border border-border/60 bg-card pb-4 transition-colors hover:border-primary", children: [
          cover ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background via-background/75 to-background/15" })
          ] }) : null,
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative text-sm font-semibold", children: s.name })
        ] }, s.id);
      }) })
    ] }),
