...
import { d as requireSupabaseAuth, o as objectType, s as stringType } from "./auth-middleware-CXeE-dWU.js";
import { s as supabaseAdmin } from "./client.server-CQTuKCic.js";
import { a as assertPhoneAvailable } from "./phone.server-DrcC5xv-.js";
import { h as hoursUntilSlot, c as CANCEL_PARTIAL_REFUND_HOURS, r as refundPaiseForCancellation, e as cancellationRefundPercent } from "./cancellation-policy-CDWg5dXD.js";
import { d as bookingStartMinute } from "./slot-time-C7HRn-Jw.js";
...
const cancelMyBooking = createServerFn({
  ...
  const refundNote = refundPercent === 100 ? "A full refund will be processed within 5–7 business days." : `A ${refundPercent}% refund (minus 10% convenience fee) will be processed within 5–7 business days.`;
