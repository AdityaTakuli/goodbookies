import { l as createServerFn, _ as reactExports, Q as jsxRuntimeExports } from "./server-CeBVfatq.js";
import { j as createLucideIcon, l as createSsrRpc, g as cn, V as useNavigate, B as Button, L as Link, P as toast } from "./router-BRNBRDAB.js";
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex max-w-md flex-col px-4 py-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: onVerifyOtp, className: "mt-8 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(InputOTP, { id: "otp", maxLength: OTP_LENGTH, value: otp, onChange: setOtp, children: /* @__PURE__ */ jsxRuntimeExports.jsx(InputOTPGroup, { children: Array.from({
            length: OTP_LENGTH
          }, (_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(InputOTPSlot, { index: i }, i)) }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", className: "w-full", disabled: loading || otp.length !== OTP_LENGTH, children: loading ? "Verifying…" : "Verify & create account" }),
