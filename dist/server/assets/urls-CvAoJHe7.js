import { T as TSS_SERVER_FUNCTION, E as getServerFnById } from "./server-BoEeNwCw.js";
...
function resolveMediaUrlAbsolute(key, fallback) {
  ...
  if (key.startsWith("/uploads/") || key.startsWith("/api/media/user/") || key.startsWith("/api/media/venue/") || key.startsWith("/api/media/asset/")) {
