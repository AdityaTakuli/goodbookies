import { _ as reactExports, L as isPromise, M as isRedirect, K as isNotFound, H as invariant, i as createControlledPromise, a6 as rootRouteId, N as isServer$1, x as functionalUpdate$1, c as arraysEqual, j as createLRUCache, g as compileDecodeCharMap, a8 as trimPath, a5 as rewriteBasepath, h as composeRewrites, Z as processRouteTree, Y as processRouteMasks, a4 as resolvePath, e as cleanPath, aa as trimPathRight, X as parseHref, s as executeRewriteInput, I as isDangerousProtocol, $ as redirect, w as findSingleMatch, n as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, d as buildRouteBranch, G as interpolatePath, W as nullReplaceEqualDeep, a1 as replaceEqualDeep$1, S as last, m as decodePath, u as findFlatMatch, v as findRouteMatch, F as hasKeys, t as executeRewriteOutput, p as encodePathLikeUrl, a9 as trimPathLeft, P as joinPaths, ac as useRouter, o as dummyMatchContext, U as matchContext, A as getDefaultExportFromCjs, a2 as requireReactDom, r as exactPathTest, a0 as removeTrailingSlash, a as React2, Q as jsxRuntimeExports, J as isModuleNotFoundError, ab as useHydrated, q as escapeHtml, y as getAssetCrossOrigin, C as getScriptPreloadAttrs, b as appendUniqueUserTags, a3 as resolveManifestCssLink, l as createServerFn, R as React, O as Outlet, V as notFound } from "./server-BDxa_Kju.js";
import { s as supabase, g as getPublicEnvInlineScript } from "./client-BjQiAFWG.js";
import { c as createSsrRpc, a as resolveMediaUrlAbsolute } from "./urls-ChthLJ-h.js";
import { d as requireSupabaseAuth, o as objectType, s as stringType, n as numberType, e as enumType, c as booleanType, b as arrayType, r as recordType, u as unknownType } from "./auth-middleware-CXeE-dWU.js";
import { b as CANCEL_FULL_REFUND_HOURS, c as CANCEL_PARTIAL_REFUND_HOURS, d as CANCEL_PARTIAL_REFUND_PERCENT, a as CANCEL_CONVENIENCE_FEE_PERCENT } from "./cancellation-policy-CDWg5dXD.js";
...
var Route$Q = class Route extends BaseRoute {
  /**
...
const appCss = "/assets/styles-DnDAj6oO.css";
const CLIENT_BUILD_ID = "c7b8aa4";
...
const claimMyPhone = createServerFn({
  method: "POST"
}).middleware([requireSupabaseAuth]).handler(createSsrRpc("b1628cc123a3972de457ef4c57c434276df100672945610a6458209c64e1b759"));
...
function AuthProvider({ children }) {
  ...
  const [accountType, setAccountType] = reactExports.useState(null);
...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer transition-[color,background-color,border-color,box-shadow,transform] duration-150 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 border-b border-border/60 bg-background/95 backdrop-blur-xl supports-[backdrop-filter]:bg-background/75", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex h-16 items-center justify-between gap-4 px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-9 w-9 place-items-center rounded-lg bg-primary text-sm text-primary-foreground shadow-[var(--shadow-glow)]", children: "GB" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Good Bookies" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden items-center gap-1 lg:flex", "aria-label": "Main", children: nav.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: n.to,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden h-9 min-w-[11.5rem] items-center justify-end gap-2 lg:flex", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-[10.5rem] animate-pulse rounded-md bg-muted/40", "aria-hidden": true }) : user ? /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "sm", onClick: () => signOut(), children: "Sign out" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, size: "sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", children: "Get started" }) })
      ] }) }),
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 top-16 z-40 lg:hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "nav",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 border-t border-border/60 pt-4", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-11 w-full animate-pulse rounded-md bg-muted/40", "aria-hidden": true }) : user ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "outline",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", className: "h-11", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/login", children: "Log in" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, className: "h-11", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", children: "Get started" }) })
            ] }) })
          ] })
        }
      )
...
const LEGAL_NAMES_MULTILINE = LEGAL_ENTITY.legalNames.map(
  (name, index) => index < LEGAL_ENTITY.legalNames.length - 1 ? `${name},` : name
).join("\n");
...
Registered and operating address: ${LEGAL_ENTITY.fullAddress}.`
  ...
  },
  {
    ...
    answer: "Player age depends on the allowed age by turf. You agree to provide accurate personal details at the time of booking. Bookings are subject to slot availability. GOOD BOOKIES reserves the right to remove any user or listing that violates our policies."
  },
  {
...
• Less than ${CANCEL_PARTIAL_REFUND_HOURS} hours before your slot — no refund`
  },
  {
    ...
    answer: "Refunds are credited to the original payment method (UPI, debit/credit card, net banking, or wallet) used at booking, via our payment partner Razorpay."
  },
  {
...
function LegalNamesList({ className = "", inline }) {
  if (inline) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className, children: LEGAL_ENTITY.legalNames.map((name, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      name,
      index < LEGAL_ENTITY.legalNames.length - 1 ? ", " : ""
    ] }, name)) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `block ${className}`, children: LEGAL_ENTITY.legalNames.map((name, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "block font-medium text-foreground", children: [
    name,
    index < LEGAL_ENTITY.legalNames.length - 1 ? "," : ""
  ] }, name)) });
}
function LegalBusinessIdentity({ compact, className = "" }) {
  if (compact) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: `text-xs leading-relaxed text-muted-foreground ${className}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: LEGAL_ENTITY.brandName }),
      " · ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(LegalNamesList, { inline: true }),
      " · ",
      LEGAL_ENTITY.fullAddress
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `space-y-2 text-sm text-muted-foreground ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-foreground/80", children: "Brand name" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: LEGAL_ENTITY.brandName })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-foreground/80", children: "Legal names" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LegalNamesList, { className: "mt-1" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-foreground/80", children: "Registered & operating address" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      LEGAL_ENTITY.addressLine1,
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      LEGAL_ENTITY.city,
      " – ",
      LEGAL_ENTITY.pincode,
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      LEGAL_ENTITY.state,
      ", ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-foreground/80", children: "Contact" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      ...
      " · ",
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `tel:+91${LEGAL_ENTITY.phone}`, className: "text-primary hover:underline", children: [
        "+91 ",
        LEGAL_ENTITY.phone
      ] })
    ] })
...
function LegalPolicyLinks({ className = "", inline }) {
  if (inline) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `flex flex-wrap gap-x-3 gap-y-1 text-xs text-muted-foreground ${className}`, children: POLICY_LINKS.map((link, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-3", children: [
      i > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-border", "aria-hidden": true, children: "|" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: link.to, className: "hover:text-primary hover:underline", children: link.label })
    ] }, link.to)) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: `space-y-2 text-sm text-muted-foreground ${className}`, children: POLICY_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: link.to, className: "transition-colors hover:text-primary", children: link.label }) }, link.to)) });
}
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-24 border-t border-border/60 bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto grid gap-8 px-4 py-12 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 font-display text-lg font-bold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-8 w-8 place-items-center rounded-lg bg-primary text-primary-foreground", children: "GB" }),
          "Good Bookies"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "Floodlit. Fast. Fully booked. Find and book your next match in seconds." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold", children: "Book" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-3 space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/sports", className: "transition-colors hover:text-primary", children: "Browse all venues" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/sports", search: { sport: "football" }, className: "transition-colors hover:text-primary", children: "Football turfs" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/sports", search: { sport: "cricket" }, className: "transition-colors hover:text-primary", children: "Cricket nets" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/lobbies", className: "transition-colors hover:text-primary", children: "Open match lobbies" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold", children: "More sports" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-3 space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/sports", search: { sport: "basketball" }, className: "transition-colors hover:text-primary", children: "Basketball" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/sports", search: { sport: "badminton" }, className: "transition-colors hover:text-primary", children: "Badminton" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold", children: "Partner" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-3 space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/owner/register", className: "transition-colors hover:text-primary", children: "List your venue" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/owner/login", className: "transition-colors hover:text-primary", children: "Partner login" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold", children: "Policies" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegalPolicyLinks, { className: "mt-3" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border/60 bg-card/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto grid gap-8 px-4 py-8 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(LegalBusinessIdentity, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm text-muted-foreground md:text-right", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: LEGAL_ENTITY.brandName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1", children: "Online sports turf booking platform" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-xs", children: "Payments processed securely via Razorpay. Prices shown in INR (₹)." })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border/60 px-4 py-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LegalPolicyLinks, { inline: true }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "container mx-auto mt-4 text-center text-xs text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-2 block text-[11px] uppercase tracking-wide text-foreground/70", children: "Legal names" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LegalNamesList, { className: "mt-1 text-center" })
      ] })
    ] })
  ] });
}
...
const SITE_NAME = "Good Bookies";
const DEFAULT_DESCRIPTION = "Find and book floodlit football turfs, cricket nets, basketball courts and more across India. Real-time slot availability, instant confirmation, open match lobbies.";
const DEFAULT_SITE_URL = "https://goodbookies.co.in";
function getSiteUrl() {
  if (typeof process !== "undefined") {
    const fromProcess = process.env.MEDIA_PUBLIC_URL?.replace(/\/$/, "") || process.env.SITE_URL?.replace(/\/$/, "") || process.env.VITE_SITE_URL?.replace(/\/$/, "");
...
function buildPageMeta({
  ...
  const ogImage = image?.startsWith("http") ? image : image ? absoluteUrl(image) : absoluteUrl("/og-image.webp");
  const meta = [
    { title: tabTitle },
...
function sportsActivityVenueJsonLd(venue) {
...
function RootShell({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { children: [
      publicEnvScript ? /* @__PURE__ */ jsxRuntimeExports.jsx("script", { dangerouslySetInnerHTML: { __html: publicEnvScript } }) : null,
      children,
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AuthProvider, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DeferredToaster, {})
  ] }) });
}
function DeferredToaster() {
  ...
  reactExports.useEffect(() => {
    if ("requestIdleCallback" in window) {
      const id2 = window.requestIdleCallback(() => setReady(true));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster2, {});
}
const $$splitComponentImporter$N = () => import("./terms-DIRafqWa.js");
...
const listSports = createServerFn({
  method: "GET"
}).handler(createSsrRpc("2d1911b40cea4595f28876660194baf9f2564e65120b302149213d9a488d877b"));
const listVenues = createServerFn({
  method: "GET"
}).inputValidator((input) => objectType({
  sport: stringType().min(1).max(64).optional()
}).parse(input ?? {})).handler(createSsrRpc("e61be094150d464993f30fda46fdd05ec3ee0956cec4523b10372fd5235d54fd"));
const getVenue = createServerFn({
  method: "GET"
}).inputValidator((input) => objectType({
  slug: stringType().min(1).max(120)
}).parse(input)).handler(createSsrRpc("a894368827ec13220f8e161064d474273c6d1f34afa7142b981ee25460a2e459"));
...
}).parse(input)).handler(createSsrRpc("233e36323445af8501bc4a10d6522cf1d74f1c6ab3d242d95184c1424c53f3d5"));
const getVenueDaySchedule = createServerFn({
  method: "GET"
}).inputValidator((input) => objectType({
  venueId: stringType().uuid(),
  date: stringType().regex(/^\d{4}-\d{2}-\d{2}$/)
}).parse(input)).handler(createSsrRpc("f26a2403204432666753550337f3622ea83d6beb98fcb5538a190a3482b32146"));
const createBooking = createServerFn({
  ...
  shareToGroup: booleanType().default(true),
  couponCode: stringType().optional(),
  paymentPlan: enumType(["full", "token"]).default("full")
}).refine((v) => v.endMinute > v.startMinute, {
  message: "endMinute must be > startMinute"
}).parse(input)).handler(createSsrRpc("d5d1516df3b15f9b01e23ed40cda22b58728aafe46e1ea4dd526f9df75ede78c"));
const listMyBookings = createServerFn({
  method: "GET"
}).middleware([requireSupabaseAuth]).handler(createSsrRpc("d1db1769e805004b7650e52069e0692b745a7216b3ba175af8cd5c999b2ea22f"));
const cancelPendingBooking = createServerFn({
  method: "POST"
}).middleware([requireSupabaseAuth]).inputValidator((input) => objectType({
  bookingId: stringType().uuid()
}).parse(input)).handler(createSsrRpc("7c14dfcc113cd3bbf268768cc70e69951ff9ee49e3d842564fc390a32a59e7ea"));
const previewBookingTotal = createServerFn({
  method: "POST"
}).inputValidator((input) => objectType({
  venueId: stringType().uuid(),
  date: stringType().regex(/^\d{4}-\d{2}-\d{2}$/),
  ...
  message: "endMinute must be > startMinute"
}).parse(input)).handler(createSsrRpc("e6e5f6e307c3410f8bd20b479e303baf289c04ab7a6749ee4bd1882e906434cc"));
const sportsQO$1 = queryOptions({
  queryKey: ["sports"],
  queryFn: () => listSports()
});
const venuesQO = (sport) => queryOptions({
...
const $$splitComponentImporter$M = () => import("./sports-D-LgKObX.js");
const searchSchema$1 = objectType({
  sport: stringType().optional()
});
const Route$N = createFileRoute("/sports")({
  ...
  loader: ({
    ...
    context.queryClient.ensureQueryData(sportsQO$1);
  ...
  head: ({
    ...
    const title = sport ? `${sport.charAt(0).toUpperCase()}${sport.slice(1)} Turfs & Venues` : "Sports Turfs & Venues";
    const description = sport ? `Browse and book ${sport} turfs and venues near you. Compare prices, ratings, and live slot availability on Good Bookies.` : "Browse and book football turfs, cricket nets, basketball courts, badminton courts and more. Filter by sport, city and price.";
...
const $$splitComponentImporter$L = () => import("./signup-e7elyvhr.js");
...
const $$splitComponentImporter$K = () => import("./scoring-C5JSnF_M.js");
const Route$L = createFileRoute("/scoring")({
  head: () => buildPageMeta({
    title: "Match Scoring",
    path: "/scoring",
    noIndex: true
...
const $$splitComponentImporter$J = () => import("./reset-password-Dml3x-xz.js");
...
const $$splitComponentImporter$I = () => import("./refund-B498W4m4.js");
const Route$J = createFileRoute("/refund")({
  head: () => buildPageMeta({
...
const $$splitComponentImporter$H = () => import("./privacy-BG7-TDkz.js");
...
const $$splitComponentImporter$G = () => import("./owner-BIBrL66y.js");
const Route$H = createFileRoute("/owner")({
  head: () => buildPageMeta({
...
const $$splitComponentImporter$F = () => import("./login-B_t39Gpw.js");
...
const $$splitComponentImporter$E = () => import("./lobbies-CHP2lmHS.js");
const Route$F = createFileRoute("/lobbies")({
  head: () => buildPageMeta({
    title: "Open Match Lobbies",
    description: "Find open match lobbies and join games near you. Filter by sport and date, then request to fill remaining spots on booked turf slots.",
    path: "/lobbies"
  }),
  component: lazyRouteComponent($$splitComponentImporter$E, "component")
});
const $$splitComponentImporter$D = () => import("./forgot-password-ncR3GNTX.js");
...
const PLAYER_HOME = "/sports";
const PARTNER_HOME = "/owner";
function resolvePlayerLoginPath(redirect2) {
  if (isSafeRedirectPath(redirect2)) return redirect2;
  return PLAYER_HOME;
}
function resolvePartnerLoginPath() {
  return PARTNER_HOME;
}
...
const $$splitComponentImporter$C = () => import("./cancellation-Bmpc8D9e.js");
const Route$C = createFileRoute("/cancellation")({
  head: () => buildPageMeta({
...
const $$splitComponentImporter$B = () => import("./admin-DUqG2arQ.js");
...
const $$splitComponentImporter$A = () => import("./account-C1EDQUtS.js");
...
const $$splitComponentImporter$z = () => import("./about-fWV0PMaX.js");
const Route$z = createFileRoute("/about")({
  head: () => buildPageMeta({
    title: "About Us",
...
const heroMobileWebp = "/assets/hero-turf-mobile-juJ1h38h.webp";
const heroWebp = "/assets/hero-turf-CgLw6gcJ.webp";
const HERO_SRCSET = `${heroMobileWebp} 800w, ${heroWebp} 1600w`;
const $$splitComponentImporter$y = () => import("./index-BHk0N6Q6.js");
const sportsQO = queryOptions({
  queryKey: ["sports"],
  queryFn: () => listSports()
});
const Route$y = createFileRoute("/")({
  ...
  head: () => {
    const {
      ...
      title: SITE_NAME,
      description: "Book floodlit football turfs, cricket nets and indoor courts online. Live slot availability, instant confirmation, and open match lobbies across India.",
      path: "/",
      image: heroWebp
    });
    return {
...
const $$splitComponentImporter$x = () => import("./scoring.index-BF9B4sRI.js");
const Route$x = createFileRoute("/scoring/")({
  component: lazyRouteComponent($$splitComponentImporter$x, "component")
});
const $$splitComponentImporter$w = () => import("./owner.index-BRH0xBiJ.js");
const Route$w = createFileRoute("/owner/")({
  component: lazyRouteComponent($$splitComponentImporter$w, "component")
});
const $$splitComponentImporter$v = () => import("./admin.index-CaxVyUpy.js");
const Route$v = createFileRoute("/admin/")({
  component: lazyRouteComponent($$splitComponentImporter$v, "component")
});
const $$splitComponentImporter$u = () => import("./account.index-uqeczIKH.js");
const Route$u = createFileRoute("/account/")({
  component: lazyRouteComponent($$splitComponentImporter$u, "component")
});
const venueQO = (slug) => queryOptions({
  queryKey: ["venue", slug],
  queryFn: () => getVenue({
    data: {
      slug
...
const $$splitComponentImporter$t = () => import("./venues._slug-CA3TxC3x.js");
const Route$t = createFileRoute("/venues/$slug")({
  loader: async ({
    context,
    params
  }) => {
  ...
  head: ({
    ...
    if (!venue) {
      return buildPageMeta({
        ...
        path: `/venues/${params.slug}`,
        noIndex: true
      });
    }
    const sportName = venue.sport?.name ?? "Sports";
    const description = venue.description?.slice(0, 155) || `Book ${venue.name} in ${venue.city}. ${sportName} turf from ₹${venue.price_per_hour}/hr. Live slots, instant confirmation on Good Bookies.`;
...
const $$splitComponentImporter$s = () => import("./scoring.new-BIff12Q5.js");
const Route$s = createFileRoute("/scoring/new")({
  component: lazyRouteComponent($$splitComponentImporter$s, "component")
});
const $$splitComponentImporter$r = () => import("./scoring._matchId-CzQM_MV7.js");
const Route$r = createFileRoute("/scoring/$matchId")({
...
const listInventoryFlags = createServerFn({
  method: "GET"
}).handler(createSsrRpc("1f73c46a1510f8151d34390c8ba7cd1e491101f1be6d0914353526258afb26f4"));
const listInventoryClubs = createServerFn({
  method: "GET"
}).inputValidator((input) => objectType({
  sport: sportSchema.optional()
}).parse(input ?? {})).handler(createSsrRpc("636d2e263181f19c1d956db121a1e3ec6198d04dce469bfc83e4755ed63ee019"));
const listAvatarInventory = createServerFn({
  method: "GET"
}).handler(createSsrRpc("cc62aff522739d755b734b1530a638cdf386917eb48781f92612adc3bfd89e83"));
const getMyPlayerDashboard = createServerFn({
  method: "GET"
}).middleware([requireSupabaseAuth]).handler(createSsrRpc("2958c4a5ec96039e4f720484041aea09a6ad24d061f2d8d835fdd6cfa68ae6dd"));
createServerFn({
  method: "GET"
}).middleware([requireSupabaseAuth]).inputValidator((input) => objectType({
  sport: sportSchema
}).parse(input)).handler(createSsrRpc("19d7fac64f903555043b2a3021143dbb63d90d8a812494154aa1741c9e324462"));
const updatePlayerProfileSettings = createServerFn({
  method: "POST"
}).middleware([requireSupabaseAuth]).inputValidator((input) => objectType({
  sport: sportSchema
}).and(settingsSchema).parse(input)).handler(createSsrRpc("2a8e6513cc7d62bc287a54ff608ec0227c2972f5ca6899a7bc0b40387924e631"));
const getPublicPlayerProfile = createServerFn({
  method: "GET"
}).inputValidator((input) => objectType({
  username: stringType().min(3).max(30),
  sport: sportSchema.optional()
}).parse(input)).handler(createSsrRpc("3f9b04f689a33b2a9c2deb83428d2775fab9cd6c2c0b40960b683f7a7229f854"));
createServerFn({
  method: "GET"
}).middleware([requireSupabaseAuth]).inputValidator((input) => objectType({
  sport: sportSchema.optional()
}).parse(input ?? {})).handler(createSsrRpc("ec685edcae7fa2e4d44da2ca1fac5f78105f78a733aedb622145b9ec62a28779"));
const profileQO = (username, sport) => queryOptions({
  queryKey: ["public-player", username, sport],
  queryFn: () => getPublicPlayerProfile({
    data: {
      username,
      sport
    }
...
const $$splitComponentImporter$q = () => import("./players._username-gj64n_uX.js");
const searchSchema = objectType({
  sport: stringType().optional()
});
const Route$q = createFileRoute("/players/$username")({
  ...
  loader: async ({
    ...
    const profile = await context.queryClient.ensureQueryData(profileQO(params.username, deps.sport));
  ...
  head: ({
    ...
    const firstCard = profile?.cards ? Object.values(profile.cards)[0] : void 0;
...
const $$splitComponentImporter$p = () => import("./owner.venues--4hSiTuN.js");
const Route$p = createFileRoute("/owner/venues")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("./owner.slots-Bn6hEBAo.js");
const Route$o = createFileRoute("/owner/slots")({
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("./owner.settings-CW9ymjAN.js");
const Route$n = createFileRoute("/owner/settings")({
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("./owner.register-D-Dgh0gQ.js");
const Route$m = createFileRoute("/owner/register")({
  head: () => buildPageMeta({
    title: "List Your Turf | Partner with Good Bookies",
    description: "Register as a turf partner on Good Bookies. List your football, cricket or multi-sport venue, manage bookings, slots and payouts from one dashboard.",
    path: "/owner/register"
  }),
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("./owner.pricing-Cdcp5Eak.js");
const Route$l = createFileRoute("/owner/pricing")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("./owner.player-stats-DoyJkBKw.js");
const Route$k = createFileRoute("/owner/player-stats")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./owner.payouts-6Fkozbs5.js");
const Route$j = createFileRoute("/owner/payouts")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("./owner.login-DXtV81at.js");
const Route$i = createFileRoute("/owner/login")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./owner.bookings-BrCOKlpX.js");
const Route$h = createFileRoute("/owner/bookings")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./owner.analytics-CnaXmbQD.js");
const Route$g = createFileRoute("/owner/analytics")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./booking.success-CresdVal.js");
const Route$f = createFileRoute("/booking/success")({
  validateSearch: objectType({
    id: stringType().optional()
  }),
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./admin.venues-CGYvaMOq.js");
const Route$e = createFileRoute("/admin/venues")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./admin.venue-approvals-K-HIZRLe.js");
const Route$d = createFileRoute("/admin/venue-approvals")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./admin.users-WdmXCO31.js");
const Route$c = createFileRoute("/admin/users")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./admin.sports-BYbHGewf.js");
const Route$b = createFileRoute("/admin/sports")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./admin.settings-Vgk6YDFu.js");
const Route$a = createFileRoute("/admin/settings")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./admin.payments-Ck097jNw.js");
const Route$9 = createFileRoute("/admin/payments")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./admin.owners-MDtlHqo6.js");
const Route$8 = createFileRoute("/admin/owners")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./admin.owner-requests-D28qxdJ5.js");
const Route$7 = createFileRoute("/admin/owner-requests")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./admin.notifications-E9oe1SBg.js");
const Route$6 = createFileRoute("/admin/notifications")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./admin.bookings-v7aj8ucT.js");
const Route$5 = createFileRoute("/admin/bookings")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./admin.analytics-B14G9xIo.js");
const Route$4 = createFileRoute("/admin/analytics")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./account.profile-CJFB1ouP.js");
const Route$3 = createFileRoute("/account/profile")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./account.payments-m6XXwZVE.js");
const Route$2 = createFileRoute("/account/payments")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./account.notifications-CIacmct7.js");
const Route$1 = createFileRoute("/account/notifications")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./account.card-CSEB_DVE.js");
const Route2 = createFileRoute("/account/card")({
...
const SportsRoute = Route$N.update({
  id: "/sports",
  path: "/sports",
  getParentRoute: () => Route$P
});
...
const ScoringRoute = Route$L.update({
  id: "/scoring",
  path: "/scoring",
  getParentRoute: () => Route$P
});
...
const RefundRoute = Route$J.update({
  id: "/refund",
  path: "/refund",
  getParentRoute: () => Route$P
});
...
const OwnerRoute = Route$H.update({
  id: "/owner",
  path: "/owner",
  getParentRoute: () => Route$P
});
...
const LobbiesRoute = Route$F.update({
  id: "/lobbies",
  path: "/lobbies",
  getParentRoute: () => Route$P
});
...
const CancellationRoute = Route$C.update({
  id: "/cancellation",
  path: "/cancellation",
  getParentRoute: () => Route$P
});
...
const AboutRoute = Route$z.update({
  id: "/about",
  path: "/about",
  getParentRoute: () => Route$P
});
...
const ScoringIndexRoute = Route$x.update({
  id: "/",
  path: "/",
  getParentRoute: () => ScoringRoute
});
const OwnerIndexRoute = Route$w.update({
  id: "/",
  path: "/",
...
const AccountIndexRoute = Route$u.update({
  id: "/",
  path: "/",
  getParentRoute: () => AccountRoute
});
const VenuesSlugRoute = Route$t.update({
  id: "/venues/$slug",
  path: "/venues/$slug",
  getParentRoute: () => Route$P
});
const ScoringNewRoute = Route$s.update({
  id: "/new",
  path: "/new",
  getParentRoute: () => ScoringRoute
});
const ScoringMatchIdRoute = Route$r.update({
  id: "/$matchId",
  path: "/$matchId",
  getParentRoute: () => ScoringRoute
});
const PlayersUsernameRoute = Route$q.update({
  id: "/players/$username",
  path: "/players/$username",
  getParentRoute: () => Route$P
});
const OwnerVenuesRoute = Route$p.update({
  id: "/venues",
  path: "/venues",
  getParentRoute: () => OwnerRoute
});
const OwnerSlotsRoute = Route$o.update({
  id: "/slots",
  path: "/slots",
  getParentRoute: () => OwnerRoute
});
const OwnerSettingsRoute = Route$n.update({
  id: "/settings",
  path: "/settings",
  getParentRoute: () => OwnerRoute
});
const OwnerRegisterRoute = Route$m.update({
  id: "/register",
  path: "/register",
  getParentRoute: () => OwnerRoute
});
const OwnerPricingRoute = Route$l.update({
  id: "/pricing",
  path: "/pricing",
  getParentRoute: () => OwnerRoute
});
const OwnerPlayerStatsRoute = Route$k.update({
  id: "/player-stats",
  path: "/player-stats",
  getParentRoute: () => OwnerRoute
});
const OwnerPayoutsRoute = Route$j.update({
  id: "/payouts",
  path: "/payouts",
  getParentRoute: () => OwnerRoute
});
const OwnerLoginRoute = Route$i.update({
  id: "/login",
  path: "/login",
  getParentRoute: () => OwnerRoute
});
const OwnerBookingsRoute = Route$h.update({
  id: "/bookings",
  path: "/bookings",
  getParentRoute: () => OwnerRoute
});
const OwnerAnalyticsRoute = Route$g.update({
  id: "/analytics",
  path: "/analytics",
  getParentRoute: () => OwnerRoute
});
const BookingSuccessRoute = Route$f.update({
  id: "/booking/success",
  path: "/booking/success",
  getParentRoute: () => Route$P
});
const AdminVenuesRoute = Route$e.update({
  id: "/venues",
  path: "/venues",
  getParentRoute: () => AdminRoute
});
const AdminVenueApprovalsRoute = Route$d.update({
  id: "/venue-approvals",
...
const AdminSportsRoute = Route$b.update({
  id: "/sports",
  path: "/sports",
  getParentRoute: () => AdminRoute
});
...
const AdminPaymentsRoute = Route$9.update({
  id: "/payments",
  path: "/payments",
  getParentRoute: () => AdminRoute
});
const AdminOwnersRoute = Route$8.update({
  id: "/owners",
  path: "/owners",
  getParentRoute: () => AdminRoute
});
const AdminOwnerRequestsRoute = Route$7.update({
  id: "/owner-requests",
  path: "/owner-requests",
  getParentRoute: () => AdminRoute
});
const AdminNotificationsRoute = Route$6.update({
  id: "/notifications",
  path: "/notifications",
  getParentRoute: () => AdminRoute
});
const AdminBookingsRoute = Route$5.update({
  id: "/bookings",
  path: "/bookings",
  getParentRoute: () => AdminRoute
});
...
const AccountProfileRoute = Route$3.update({
  id: "/profile",
  path: "/profile",
  getParentRoute: () => AccountRoute
});
const AccountPaymentsRoute = Route$2.update({
  id: "/payments",
  path: "/payments",
  getParentRoute: () => AccountRoute
});
const AccountNotificationsRoute = Route$1.update({
  id: "/notifications",
  path: "/notifications",
  getParentRoute: () => AccountRoute
});
const AccountCardRoute = Route2.update({
  id: "/card",
  path: "/card",
  getParentRoute: () => AccountRoute
});
...
const AdminRouteChildren = {
  ...
  AdminOwnerRequestsRoute,
  AdminOwnersRoute,
  AdminPaymentsRoute,
  AdminSettingsRoute,
  AdminSportsRoute,
  AdminUsersRoute,
  AdminVenueApprovalsRoute,
  AdminVenuesRoute,
  AdminIndexRoute
};
...
const ScoringRouteChildren = {
  ScoringMatchIdRoute,
  ScoringNewRoute,
  ScoringIndexRoute
};
const ScoringRouteWithChildren = ScoringRoute._addFileChildren(ScoringRouteChildren);
...
export {
  ...
  getMyPlayerDashboard as D,
  getSlots as E,
  getVenueDaySchedule as F,
  heroMobileWebp as G,
  HERO_SRCSET as H,
  isValidTimeout as I,
  listAvatarInventory as J,
  listInventoryClubs as K,
  LEGAL_ENTITY as L,
  listInventoryFlags as M,
  listMyBookings as N,
  listSports as O,
  PLAYER_HOME as P,
  noop as Q,
  ...
  TERMS_SECTIONS as T,
  notifyManager as U,
  organizationJsonLd as V,
  pendingThenable as W,
  X,
  previewBookingTotal as Y,
  profileQO as Z,
  reactDomExports as _,
  LegalBusinessIdentity as a,
  resolvePartnerLoginPath as a0,
  resolvePlayerLoginPath as a1,
  resolveQueryBoolean as a2,
  resolveStaleTime as a3,
  router as a4,
  shallowEqualObjects as a5,
  shouldThrowError as a6,
  sportsActivityVenueJsonLd as a7,
  sportsQO$1 as a8,
  timeUntilStale as a9,
  timeoutManager as aa,
  toast as ab,
  updatePlayerProfileSettings as ac,
  useAuth as ad,
  useComposedRefs as ae,
  useNavigate as af,
  useQueryClient as ag,
  useRouterState as ah,
  venueQO as ai,
  venuesQO as aj,
  websiteJsonLd as ak,
  LegalNamesList as b,
  LegalPolicyLinks as c,
  Link as d,
  PRIVACY_SECTIONS as e,
  ReactDOM as f,
  Route$N as g,
  Route$G as h,
  Route$y as i,
  ...
  Route$q as l,
  Route$f as m,
  breadcrumbJsonLd as n,
  cancelPendingBooking as o,
  checkPhoneAvailable as p,
  clsx as q,
  cn$1 as r,
  composeRefs as s,
  createBooking as t,
