import { Q as jsxRuntimeExports, _ as reactExports } from "./server-Cnaa2j9o.js";
import { j as createLucideIcon, g as cn$1, U as useComposedRefs, q as getMyPlayerDashboard, Q as updatePlayerProfileSettings, u as listInventoryClubs, v as listInventoryFlags, t as listAvatarInventory, W as useQueryClient, L as Link, B as Button, P as toast } from "./router-D_GlHo_6.js";
...
import { F as FutPlayerCard, S as ShareCardButton, M as MatchHistoryList } from "./ShareCardButton-BE7ognNZ.js";
import { I as Input } from "./input-xJAcN1KZ.js";
import { L as Label } from "./label-CLdfeOSP.js";
import { u as useControllableState, P as Primitive, c as composeEventHandlers, b as createContextScope } from "./index-WPaCx-LU.js";
import { u as usePrevious, a as useSize } from "./index-CKic8EBw.js";
import { p as parseSkillLevel, P as PLAYER_SKILL_LEVELS, a as PLAYER_SKILL_LEVEL_LABELS } from "./player-card.utils-Dn3fVHr0.js";
import { u as uploadMediaFile, a as uploadMediaFileToHostinger } from "./upload-client-CR-dltJ9.js";
...
function CardBuilderSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: cn$1("rounded-xl border border-[#1E3A27]/80 bg-[#142219] p-4 sm:rounded-2xl sm:p-5", className), children: [
    ...
    sport === "football" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            "Goals by turf",
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: cn$1("h-4 w-4 transition-transform", turfOpen && "rotate-180") })
          ]
        }
      ),
