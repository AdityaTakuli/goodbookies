...
import { r as resolveAvatarDisplay, g as getCardSkillLevel, a as PLAYER_SKILL_LEVEL_LABELS } from "./player-card.utils-BjTbZwr2.js";
import { g as getSportConfig, S as SPORT_CONFIGS } from "./player-sports-D0yo17RI.js";
import { j as createLucideIcon, g as cn, B as Button, P as toast } from "./router-BOWNgUDI.js";
const __iconNode$2 = [
...
function ElectricCardBorder({ children, className, captureId }) {
  const filterId = `electric-border-${reactExports.useId().replace(/:/g, "")}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "electric-player-card__svg", "aria-hidden": true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "filter",
          {
            id: filterId,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ElectricCardBorder, { captureId, className: cn("fut-player-card select-none", className), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mt-3 grid grid-cols-2 gap-x-3 gap-y-2 px-1 sm:mt-4 sm:gap-x-4 sm:px-2", children: attrOrder.map((key, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("flex items-baseline justify-between", i % 2 === 0 ? "pr-1 sm:pr-2" : "pl-1 sm:pl-2"), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg font-bold text-white sm:text-xl", children: data.cardRatings[key] ?? 50 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-primary/90 sm:text-[11px]", children: key })
        ] }, key)) }),
...
function MatchHistoryList({
  ...
  if (rows.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "rounded-xl border border-dashed border-border/60 px-4 py-6 text-center text-sm text-muted-foreground", children: "No verified match results yet. Scorelines appear when turf owners confirm your games." });
  }
